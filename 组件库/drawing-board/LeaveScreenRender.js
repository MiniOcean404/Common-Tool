...
class LeaveScreenRender {
  ...
  constructor(width, height) {
    ...
    this.#offlineCtx = LeaveScreenRender.offlineCtx =  this.#canvas.getContext('2d')
  ...
  render(showCtx,canvasData) {
    ...
    this.#cancelAnimationFrameID = window.requestAnimationFrame(() => {
      ...
      const data = this.#offlineCtx.getImageData(0, 0,this.#canvas.width,this.#canvas.height)
